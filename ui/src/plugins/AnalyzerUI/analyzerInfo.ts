export const analyzerInfo = {
  ...
  hold:
    'Freezes the peak-hold spectrum (no decay). Useful in Average / Max / Stereo to compare peaks while the live curve keeps moving.',
  fftSize:
  ...
  scale:
    'Display tilt pivoted at 1 kHz. Linear = raw dBFS. −3 dB/oct ≈ pink / classic balance (looks flat). −4.5 dB/oct ≈ modern/bass-heavy masters (SPAN default). Tilted views show a filled midband ±6 dB corridor as a balance guide.',
};
